...
abstract class AppRequestsEnums {
  static String CODE_TYPE = 'code';
  static String BOX_TYPE = 'box_type';
  static String NAME_TYPE = 'name';
  static String EMAIL_TYPE = 'email';
  static String FIRST_DAY = 'first_day';
  static String SECOND_DAY = 'second_day';
  static String USER_ID = 'user_id';

  // create exercise param
  ...
  static String TOTALTIMEEND = 'total_time';
